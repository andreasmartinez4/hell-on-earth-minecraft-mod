...
public class HellChunkGenerator extends NoiseChunkGenerator<HellGenSettings> {
	...
	private HellBiomeProvider biomeProvder;


	public HellChunkGenerator(World worldIn, HellBiomeProvider provider, HellGenSettings settingsIn) {
